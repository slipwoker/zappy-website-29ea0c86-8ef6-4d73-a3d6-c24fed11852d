...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    if (contactForm) { 
        contactForm.addEventListener('submit', async function(e) { 
            ...
            if (!window.zappyContactFormLoaded) {
                ...
                try {
                    ...
                    const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                        ...
                        body: JSON.stringify({
                            websiteId: '29ea0c86-8ef6-4d73-a3d6-c24fed11852d',
                            name: formDataObj.name || formDataObj.fullname || formDataObj.full_name || '',
                            email: formDataObj.email || '',
                            subject: formDataObj.subject || 'Booking Request - Hesa Wellness Spa Ubud',
                            message: formDataObj.message || formDataObj.comments || formDataObj.notes || '',
                            phone: formDataObj.phone || formDataObj.telephone || formDataObj.mobile || null
                        })
                    });
            ...
            alert('Thank you for your booking request! We will contact you within 24 hours to confirm your appointment at Hesa Wellness Spa Ubud.'); 
            contactForm.reset(); 
        }); 
    } 
});
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Hesa Wellness Spa Ubud uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
